...
ball_model = YOLOV5(weights="./lib/yolov5/checkpoint/yolov5s_basketball.pt")
...
while cap.isOpened():
    ...
    if success:
        ...
        # cv2.imwrite(f'./kun_images/{cnt}.jpg', frame)
        # cnt += 1
        # continue
        ...
        for results in ball_results_list:
            # results.boxes.xyxy: tensor([[476.2547, 300.5834, 551.5522, 376.2247]], device='cuda:0')
