...
from yolov5_utils.general import LOGGER, colorstr, cv2
from yolov5_utils.loggers.clearml.clearml_utils import ClearmlLogger
from yolov5_utils.loggers.wandb.wandb_utils import WandbLogger
from yolov5_utils.plots import plot_images, plot_labels, plot_results
from yolov5_utils.torch_utils import de_parallel
...
try:
    if RANK in {0, -1}:
        ...
        from yolov5_utils.loggers.comet import CometLogger
